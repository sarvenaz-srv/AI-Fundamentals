...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.startingState = startingGameState #to be used for heuristic based on maze distance
...
def cornersHeuristic(state, problem):
    ...
    for unvisitedCorner in unvisitedCorners:
        mazeDistances.append(mazeDistance(position,unvisitedCorner,problem.startingState))
